      ...
      <div class="container">
        <div class="row mb-5">
          <div class="col-md-7 text-left border-primary">
            <h2 class="font-weight-light text-primary">Detail</h2>
          </div>
        </div>
        ...
        <div class="row mt-5">
          ...
          <div class="col-lg-12">
            <div class="d-block d-md-flex listing">
              <a href="listings-single.php" class="img d-block" style="background-image: url('<?php echo $data['gambar']; ?>')"></a>
              <div class="lh-content">
                <span class="category"><?php echo $data['kategori']."<br>"; ?></span>
                <h3><a href="listings-single.html">
                  <?php 
                    echo $data['judul']."<br>";
                  ?>
                  </a></h3>
                <address><?php echo $data['released']."<br>"; ?></address>
                <p class="mb-0">
